...
def main(datacube, outdir, DIT, NDIT, grating, spax, seeing, air_mass, version,\
    ...
    if hsimlog.count_error == 0 and hsimlog.count_warning == 0:
        logging.info('Simulation completed OK - ' + str(hsimlog.count_error) + " errors and " + str(hsimlog.count_warning) + " warnings")
    else:
        logging.warning('Simulation completed with problems - ' + str(hsimlog.count_error) + " errors and " + str(hsimlog.count_warning) + " warnings")
