...
Started 28-05-13
Last edited 27-10-17 by Laurence Routledge
'''
...
def main(datacube, outdir, DIT, NDIT, grating, spax, seeing, zenith_ang, telescope='E-ELT', user_PSF='None',
    ...
    [config_data['trans_wo_grat']], sky=True, telescope=True, instrument=True, QE=True)
    ...
    [config_data['trans_wo_grat']], sky=False, telescope=False, instrument=True, QE=True)
    #Quantum efficiency cube
    qe_cube = create_thruput_cube(out_cube.shape, lambs, delta_lambda, grating, zenith_ang,
    [config_data['trans_wo_grat']], sky=False, telescope=False, instrument=False, QE=True)
    ...
    common_header_info = {'DIT': DIT, 'NDIT': NDIT, 'SEEING': seeing, 'ZENITH': zenith_ang, 'AOMODE': AO,
                          ...
                          'FUNITS': 'electrons', 'VERSION': version, 'DATACUBE': datacube}
...
if __name__=="__main__":
    ...
    if len(sys.argv) != 21:
        ...
        print ""
        print 'Use -p or --proc to set the number of processors'
        print 'Use -o or --odir to set the output directory'
