...
Finally, the input data cube should be in surface brightness units. The accepted units are the following:
\texttt{erg/s/cm2/um/arcsec2}, \texttt{erg/s/cm2/A/arcsec2}, \texttt{J/s/m2/um/arcsec2}, and \texttt{J/s/m2/A/arcsec2}.
...
\item Grating: Indicates the HARMONI grating. The available options are the following: \texttt{V+R, Iz+J, H+K, Iz, J, H, K, z, J-high, H-high, K-high, K-high1, K-high2}.
\item Spaxel Scale: HARMONI spatial scale in mas. The available values are the following: \texttt{4x4, 10x10, 20x20, 30+x60}.
\item Zenith seeing: Atmospheric seeing FWHM in arcsec. The available values are the following: \texttt{0.63, 0.71, 0.84, 1.11, 1.32}.
...
\item AO mode: Adaptive optics mode of the observations. The available values are the following: \texttt{LTAO, noAO}. \texttt{LTAO} corresponds to the Laser Tomography Adaptive Optics mode and \texttt{noAO} indicates that no adaptive optics corrections are applied.
