...
HSIM is programmed in Python3 and the source code can be found at  \url{https://github.com/HARMONI-ELT/HSIM}. It does not require any installation, just download it from \url{....} and unzip. HSIM depends on the following Python packages to work:
