...
##            psf = create_psf_channel(psfvars[0], l, n.max([head['CDELT1'],head['CDELT2']]),
##                                     (head['CDELT1'],head['CDELT2']),psfvars[2], psfvars[3],
##                                     psfvars[4])
...
def pp_wavelength_channel(chann, head, wavels, l, AO, psfvars, adrval, newsize, outspax, adr_switch):
    '''Function to take input datacube and process it iteratively through
    each wavelength channel as follows:
    - Generate PSF array for given channel
    - Add effect of ADR to channel
    ...
    if psfvars[-1] != 'None':
        ...
        psf = create_Gausspsf_channel(wavels[l], psfvars[5], psfvars[3], psfvars[4], psfvars[2], False,
